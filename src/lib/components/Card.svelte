...
<style lang="postcss">
  section {
    @apply h-full rounded-2xl p-4 transition-all md:rounded-3xl md:p-8;
  ...
  @media (hover: hover) {
    section {
      ...
      @apply hover:scale-105 hover:ring-2 hover:ring-amber-500;
      @apply dark:hover:shadow-stone-950 dark:hover:ring-amber-400;
    }
  }
</style>
